...
class AllPostsAPI(generics.ListAPIView):
    ...
    @swagger_auto_schema(operation_description="Get all posts")
...
class EditPostAPI(generics.RetrieveUpdateAPIView):
    ...
    @swagger_auto_schema(operation_description="Update a post",
                         request_body=PostSerializer,
...
class DeletePostAPI(generics.DestroyAPIView):
    ...
    @swagger_auto_schema(operation_description="Delete a post")
